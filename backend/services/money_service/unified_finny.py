...
class UnifiedFinny:
    ...
    def _show_comprehensive_dashboard(self, user_id):
        ...
        if health['overall_score'] >= 80:
            ...
            print("   ⚠️ Room for improvement - focus on budget adherence")
    ...
    def _budget_setup_monitoring(self, user_id):
        ...
        for category in categories:
            ...
            try:
                ...
                if budget > 0:
                    ...
                    print(f"   ⏭️ Skipping {category.lower()}")
            except ValueError:
                print(f"   ⏭️ Skipping {category.lower()}")
        ...
        if budgets:
            ...
            print(f"\n⏭️ No budgets set for {month_name} {year}")
    ...
    def _show_budget_monitoring(self, user_id):
        ...
        for alert in alerts:
            status_emoji = "✅" if alert['level'] == 'ON_TRACK' else ("⚠️" if alert['level'] == 'WARNING' else "🚨")
    ...
    def _show_financial_health_score(self, user_id):
        ...
        if health['overall_score'] >= 80:
            ...
            print("   ⚠️ Moderate financial health")
        ...
        if components['category_balance'] < 60:
            print("   ⚖️ Diversify spending across categories")
