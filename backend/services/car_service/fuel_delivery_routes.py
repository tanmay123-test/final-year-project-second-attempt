...
@fuel_delivery_bp.route('/agents/available/list', methods=['GET'])
...
@fuel_delivery_bp.route('/agent/register', methods=['POST'])
...
@fuel_delivery_bp.route('/agent/login', methods=['POST'])
...
@fuel_delivery_bp.route('/agent/status/update', methods=['POST'])
...
@fuel_delivery_bp.route('/agent/requests/queue', methods=['GET'])
...
@fuel_delivery_bp.route('/agent/assign/request/legacy', methods=['POST'])
...
@fuel_delivery_bp.route('/agent/complete/delivery/legacy', methods=['POST'])
...
@fuel_delivery_bp.route('/agent/history/<int:agent_id>/legacy', methods=['GET'])
def get_delivery_history_legacy(agent_id):
...
@fuel_delivery_bp.route('/agent/performance/<int:agent_id>/legacy', methods=['GET'])
def get_agent_performance_legacy(agent_id):
...
@fuel_delivery_bp.route('/agent/nearby/agents', methods=['GET'])
...
@fuel_delivery_bp.route('/agent/create/request', methods=['POST'])
...
@fuel_delivery_bp.route('/agent/status', methods=['POST'])
...
@fuel_delivery_bp.route('/agent/requests', methods=['GET'])
def get_fuel_requests_queue_engine():
...
@fuel_delivery_bp.route('/queue/assign/request', methods=['POST'])
def assign_fuel_request_queue():
