...
def truck_operator_login():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"🏙️ City: {result.get('city_name')}")
...
def truck_operator_dashboard(worker_info):
    ...
    while True:
        ...
        print(f"🏙️ City: {worker_info['city_name']}")
...
def view_truck_operator_profile(worker_info):
    ...
    print(f"🏙️ City: {worker_info['city_name']}")
    print(f"🆔 Worker ID: {worker_info['worker_id']}")
    print(f"🏷️ Worker Type: Truck Operator")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if analytics_data['success']:
                ...
                print(f"⏱️ Average Delivery Time: {analytics_data.get('avg_delivery_time', 0)} hours")
            else:
