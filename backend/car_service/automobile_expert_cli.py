...
def automobile_expert_dashboard(worker_info):
    ...
    while True:
        ...
        print("5.    Performance, Reputation & Support")
        print("6. Logout")
...
def view_expert_profile(worker_info):
    ...
    print(f"   Worker Type: Automobile Expert")
            ...
            if history_data['success']:
                ...
                if not consultations:
                    ...
                    for i, consultation in enumerate(consultations, 1):
                        ...
                        print(f"       Duration: {consultation.get('duration_seconds', 0)} seconds")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if analytics_data['success']:
                ...
                print(f"   Average Duration: {analytics_data.get('average_duration_seconds', 0)} seconds")
                print(f"  Online Hours: {analytics_data.get('online_hours', 0)}")
                print(f"   Reliability Score: {analytics_data.get('reliability_score', 0)}/5.0")
                ...
                if resolution_rate >= 90:
                    ...
                    print("   Resolution rate needs improvement")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if reputation_data['success']:
                ...
                print(f"   Reliability Score: {reputation_data.get('reliability_score', 0)}/5.0")
        ...
        if response.status_code == 200:
            ...
            if queue_data['success']:
                ...
                if oldest:
                    ...
                    print(f"   Waiting since: {oldest.get('created_at')}")
                ...
                if newest:
                    ...
                    print(f"   Waiting since: {newest.get('created_at')}")
...
def view_performance_support(worker_info):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print("\n" + "="*60)
            print("   PERFORMANCE, REPUTATION & SUPPORT")
            print("="*60)
            ...
            print(f"   Avg Session Time: {performance_stats.get('avg_duration_minutes', 0)} minutes")
        ...
        if response.status_code == 200:
            ...
            if current_consultation:
                ...
                if session_response.status_code == 200:
                    ...
                    print(f"   Duration: {session_data.get('duration_text', 'N/A')}")
                    ...
                    print(f"   Images: {session_data.get('images_count', 0)}")
...
def view_session_images(worker_info, session_id):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"\n   SESSION IMAGES ({len(images)} images)")
            print("="*40)
...
def update_session_note(worker_info, session_id):
    ...
    try:
        ...
        new_note_text = input(f"\n   Enter new note text (current: {selected_note.get('note_text', 'N/A')}): ").strip()
...
def expert_call_interface(worker_info, session_id):
    ...
    while call_active:
        ...
        if choice == "1":
            ...
            print("   Call paused - Press Enter to resume...")
            input()
...
def confirm_expert_end_call():
    ...
    try:
        confirm = input("   Are you sure you want to end this call? (y/N): ").strip().lower()
        return confirm == 'y'
    except:
        return False
...
def complete_active_consultation(worker_info, session_id):
    ...
    try:
        confirm = input("   Are you sure you want to complete this consultation? (y/N): ").strip().lower()
        if confirm != 'y':
            return
