...
def fuel_delivery_agent_dashboard(agent_info):
    ...
    while True:
        ...
        print("5. 🛡️ Performance, Reputation & Safety")
        print("6. 🚪 Logout")
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            for i, delivery in enumerate(history[-10:], 1):  # Show last 10
                fuel_emoji = "⛽" if delivery.get('fuel_type') == 'Petrol' else "🛢️"
...
def view_performance(agent_info):
    ...
    print("\n" + "="*60)
    print("🛡️ PERFORMANCE & REPUTATION")
    print("="*60)
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            if badges:
                print(f"\n🏆 EARNED BADGES:")
                for badge in badges:
                    print(f"   🎖️ {badge.get('badge_type', 'N/A')}")
