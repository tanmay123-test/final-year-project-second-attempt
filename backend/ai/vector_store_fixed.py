...
class VectorStore:
    ...
    async def add_documents_to_vector_store(self, documents: List[Dict[str, Any]], collection_id: Optional[str] = None):
        ...
        try:
            ...
            target_collection_id = collection_id or "financial_education"
            ...
            url = f"{self.base_url}/v1/collections/{target_collection_id}/documents"
            headers = {"x-goog-api-key": self.api_key}
    ...
    async def search_knowledge(self, query: str, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        """
        try:
            collection_id = "financial_education"
    ...
    def get_document_content(self, doc_id: str) -> Optional[str]:
        ...
        try:
            collection_id = "financial_education"
            url = f"{self.base_url}/v1/collections/{collection_id}/documents/{doc_id}"
            headers = {"x-goog-api-key": self.api_key}
    ...
    def calculate_similarity(self, text1: str, text2: str) -> float:
        ...
        try:
            ...
            if len(embeddings1[0]) == 0 or len(embeddings2[0]) == 0:
                return 0.0
    ...
    def get_vector_count(self, collection_id: Optional[str] = None) -> int:
        ...
        try:
            target_collection_id = collection_id or "financial_education"
            url = f"{self.base_url}/v1/collections/{target_collection_id}"
            headers = {"x-goog-api-key": self.api_key}
