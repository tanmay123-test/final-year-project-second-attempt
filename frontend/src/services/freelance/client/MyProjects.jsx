  ...
  return (
    <div className="my-projects-page">
        ...
        <div className="nav-container">
          ...
          <div className="nav-right">
            <nav className="nav-links-desktop">
              ...
              <button className="nav-link-item active" onClick={() => navigate('/freelance/home?tab=projects')}>
      ...
      <nav className="freelance-bottom-nav mobile-only">
        ...
        <button className="nav-item active" onClick={() => navigate('/freelance/home?tab=projects')}>
