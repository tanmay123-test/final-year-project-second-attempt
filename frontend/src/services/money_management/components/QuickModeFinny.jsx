...
import styles from '../styles/QuickModeFinny.module.css';

const QuickModeFinny = () => {
  ...
  return (
    <div className={styles.finnyMobileContainer}>
      {/* Mobile Header */}
      <header className={styles.finnyHeader}>
      ...
      <div className={styles.navTabs}>
        <button 
          className={`${styles.navTab} ${activeTab === 'quick-add' ? styles.active : ''}`}
        ...
        <button 
          className={`${styles.navTab} ${activeTab === 'summary' ? styles.active : ''}`}
      ...
      {/* Main Content */}
      <main className={styles.finnyMainContent}>
        ...
        {activeTab === 'quick-add' && (
          <div className={styles.quickAddContent}>
            <div className={styles.placeholderContent}>
              <p>Quick Add tab opens the add transaction modal</p>
            </div>
          </div>
        )}
      ...
      {/* Bottom Navigation */}
      <div className={styles.finnyBottomNav}>
        <button className={`${styles.bottomNavItem} ${activeTab === 'quick-add' ? styles.active : ''}`}>
          <div className={`${styles.navIcon} ${styles.finnyIcon}`}>F</div>
          <span>Finny</span>
        </button>
        <button className={`${styles.bottomNavItem} ${activeTab === 'summary' ? styles.active : ''}`}>
          <div className={`${styles.navIcon} ${styles.budgetIcon}`}>B</div>
          <span>Budget</span>
        </button>
        <button className={styles.bottomNavItem}>
          <div className={`${styles.navIcon} ${styles.loanIcon}`}>L</div>
          <span>Loan</span>
        </button>
        <button className={styles.bottomNavItem}>
          <div className={`${styles.navIcon} ${styles.goalIcon}`}>G</div>
          <span>Goal Jar</span>
        </button>
        <button className={styles.bottomNavItem}>
          <div className={`${styles.navIcon} ${styles.aiIcon}`}>AI</div>
          <span>AI Coach</span>
        </button>
      </div>
