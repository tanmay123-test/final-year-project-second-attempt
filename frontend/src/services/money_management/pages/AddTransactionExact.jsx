...
import styles from '../styles/AddTransactionExact.module.css';

const AddTransactionExact = () => {
  ...
  return (
    <div className={styles.exactContainer}>
      {/* Mobile Header */}
      <header className={styles.exactHeader}>
      ...
      {/* Main Content */}
      <main className={styles.exactMainContent}>
...
export default AddTransactionExact;
