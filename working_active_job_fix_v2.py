#!/usr/bin/env python3
"""
Working fix for active jobs - use correct database paths
"""
...
print("🔧 Working Active Job Fix v2...")
...
try:
    ...
    if accepted_job:
        ...
        if location_data:
            ...
            print("   ⚠️ Mechanic location not found in smart_search_db")
            # Use default location
            mechanic_lat, mechanic_long = 19.0954, 72.8783  # Asalpha Mumbai
